      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">請求書データを正しく取得できませんでした。</p>
            <Link
              href="/billing"
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">申請確認</h1>
          <p className="text-gray-600 mt-1">請求書の内容を確認して申請してください</p>
        </div>

        <div className="bg-white rounded-lg shadow-sm">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">請求書内容確認</h2>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">請求番号</label>
                <p className="text-gray-900">{form.billingNumber}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-900">{form.projectId}</p>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 pt-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-gray-900">{formatCurrency(form.totalAmount)}</span>
              </div>
            </div>
